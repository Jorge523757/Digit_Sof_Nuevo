...
DB_Nombre_de_usuario = os.getenv('DB_Nombre_de_usuario' , None)
DB_PASS     = os.getenv('DB_PASS'     , None)
DB_HOST     = os.getenv('DB_HOST'     , None)
DB_PORT     = os.getenv('DB_PORT'     , None)
DB_NAME     = os.getenv('DB_NAME'     , None)

if DB_ENGINE and DB_NAME and DB_Nombre_de_usuario:
    DATABASES = { 
      'default': {
        'ENGINE'  : 'django.db.backends.' + DB_ENGINE, 
        'NAME'    : DB_NAME,
        'USER'    : DB_Nombre_de_usuario,
        'PASSWORD': DB_PASS,
        'HOST'    : DB_HOST,
        'PORT'    : DB_PORT,
        }, 
...
DYNAMIC_DATATB = {
    # SLUG -> Import_PATH 
    'product' : "apps.PaginaPrincipal.models.Product",
}
########################################
