...
<head>
    ...
    <style>
        ...
        .header {{ background: linear-gradient(135deg, #1e3c72 0%, #2a5298 50%, #00b4d8 100%) !important; color: white; padding: 30px; text-align: center; border-radius: 10px 10px 0 0; }}
